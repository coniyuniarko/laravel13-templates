...
<body class="font-sans antialiased">
  ...
  <label class="swap swap-rotate fixed bottom-6 right-6 z-50 btn btn-circle btn-ghost bg-base-200 shadow-xl">
    <!-- this hidden checkbox controls the state -->
    <input type="checkbox" class="theme-controller" value="dark" onchange="
